...
plt.plot(x, y1, label= names[0], marker='o', markersize=5)
plt.plot(x, y2, label= names[1], marker='s', markersize=5)
plt.plot(x, y4, label= names[2], marker='v', markersize=5)
...
plt.ylabel('Errors', fontsize=12, labelpad=10)
plt.legend(loc='upper right')
plt.title('Absolute error of numerical derivative of $cosx}$ at x=1', fontsize=15, y=1.03)
